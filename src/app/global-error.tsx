        ...
        <div style={styles.page}>
          <div style={styles.container}>
            <div style={styles.header}>
              <span>⚠</span>
              <h1 style={styles.title}>Erreur globale (layout)</h1>
            </div>
            ...
            <div style={styles.actions}>
              ...
              <button onClick={() => { window.location.href = '/' }} style={styles.btnSecondary}>Accueil</button>
            </div>
          </div>
        </div>
      </body>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  blockLabel: { fontSize: '0.7rem', marginBottom: '0.5rem', textTransform: 'uppercase' as const, letterSpacing: '0.05em' },
  blockValue: { fontSize: '0.9rem', color: '#e5e5e5', wordBreak: 'break-all' as const },
  pre: { margin: 0, fontSize: '0.75rem', color: '#d1d5db', overflowX: 'auto' as const, whiteSpace: 'pre-wrap' as const, wordBreak: 'break-all' as const, lineHeight: 1.6 },
