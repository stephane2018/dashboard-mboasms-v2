          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2 animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Button variant="default" size="lg" className="rounded-xl bg-white hover:bg-white/90 text-[#3A1659] px-6 h-auto py-3 font-semibold shadow-md shadow-black/10 hover:shadow-lg hover:scale-[1.03] active:scale-[0.98] transition-all duration-200" asChild>
                ...
                <Button variant="default" size="lg" className="rounded-xl bg-white/10 hover:bg-white/20 text-white px-6 h-auto py-3 border border-white/20 hover:border-white/40 font-semibold backdrop-blur-sm hover:scale-[1.03] active:scale-[0.98] transition-all duration-200" asChild>
                  <a href="#" className="flex items-center">
                    <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="mt-8">
            ...
            <div className="mt-12 text-center animate-fade-in-up">
              ...
              <Button variant="outline" className="rounded-xl border-border hover:border-primary/40 hover:bg-primary/5 font-semibold active:scale-[0.98] transition-all duration-200" onClick={() => setScheduleCallOpen(true)}>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="rounded-xl bg-white hover:bg-white/90 text-primary font-semibold px-8 h-12 shadow-md shadow-black/10 hover:shadow-lg hover:scale-[1.03] active:scale-[0.98] transition-all duration-200" asChild>
              <a href="/compte" className="flex items-center justify-center">
                {t.cta.primary}
                <ArrowRight2 size="18" color="currentColor" className="ml-2" />
              </a>
            </Button>
            <Button onClick={() => setScheduleCallOpen(true)} variant="outline" size="lg" className="rounded-xl border-white/20 text-white hover:bg-white/10 hover:border-white/40 font-semibold px-8 h-12 backdrop-blur-sm active:scale-[0.98] transition-all duration-200">
              <span className="flex items-center">
                {t.cta.secondary}
                <ArrowRight2 size="18" color="currentColor" className="ml-2" />
              </span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="text-center md:text-left">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    <Button onClick={() => setScheduleCallOpen(true)} className="rounded-xl bg-primary text-white font-semibold px-6 shadow-md shadow-primary/25 hover:shadow-lg hover:shadow-primary/30 hover:scale-[1.03] active:scale-[0.98] transition-all duration-200">
                      <span className="flex items-center">
                        {t.contact.schedule}
