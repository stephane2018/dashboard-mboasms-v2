          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <a href="mailto:contact@mboasms.com" className="text-muted-foreground hover:text-primary transition-colors text-sm">
                  contact@mboasms.com
                </a>
              </li>
              <li className="flex items-start">
                ...
                <a href="tel:+2376XXXXXXXX" className="text-muted-foreground hover:text-primary transition-colors text-sm">
                  +237 6XX XXX XXX
                </a>
              </li>
            </ul>
